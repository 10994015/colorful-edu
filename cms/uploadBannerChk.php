...
if(isset($_FILES['banner']) && $_FILES['banner']){
    ...
    $error     = $file['error'];   
    $imgsrc = 'http://localhost/colorful-edu/images/img_upload2/'.$rand.$file_name;

    $sql_str = "INSERT INTO banner (files_name,sortnum,url) VALUES (:imgsrc,:sort,:url)";

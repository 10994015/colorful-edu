...
if($_FILES['files_name']['name']!=""){
    if(isset($_POST['id']) && $_POST['id']!=""){
        try{
            ...
            $sql_str = "UPDATE course SET coursename=:name, coursetype=:coursetype, bigtype=:bigtype, url=:url, content=:content,files_name=:files_name WHERE id=:id";
    ...
    if(isset($_POST['id']) && $_POST['id']!=""){
        try{
            $sql_str = "UPDATE course SET coursename=:name, coursetype=:coursetype, bigtype=:bigtype, url=:url, content=:content WHERE id=:id";
            $stmt = $conn->prepare($sql_str);
